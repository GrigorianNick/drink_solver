...
#[derive(
    Clone, Copy, Debug, Default, PartialEq, Eq, Serialize, Deserialize, Hash, EnumString, EnumIter,
)]
pub enum Quality {
    Low,
    Medium,
...
mod test {
    ...
    fn test_selector_quality() {
        ...
        let high_ingredient1 = Ingredient {
            name: "high_1".into(),
            quality: Quality::High,
            ..Default::default()
        };
        store.register(high_ingredient1);
        let high_ingredient2 = Ingredient {
            name: "high_2".into(),
            quality: Quality::High,
            ..Default::default()
        };
        store.register(high_ingredient2);
        let mid_ingredient1 = Ingredient {
            name: "mid_1".into(),
            quality: Quality::Medium,
            ..Default::default()
        };
        store.register(mid_ingredient1);
        let mid_ingredient2 = Ingredient {
            name: "mid_2".into(),
            quality: Quality::Medium,
            ..Default::default()
        };
        store.register(mid_ingredient2);
        let low_ingredient1 = Ingredient {
            name: "low_1".into(),
            quality: Quality::Low,
            ..Default::default()
        };
        store.register(low_ingredient1);
        let low_ingredient2 = Ingredient {
            name: "low_2".into(),
            quality: Quality::Low,
            ..Default::default()
        };
        ...
        for qual in vec![Quality::Low, Quality::Medium, Quality::High] {
            let selector = IngredientSelector {
                name: None,
                quality: Some(qual),
                tags: None,
                in_stock: None,
    ...
    fn test_selector_name() {
        // Setup
        let mut store = IngredientStore::default();
        let dupe_1 = Ingredient {
            name: "dupe".into(),
            quality: Quality::Low,
            ..Default::default()
        };
        let dupe_2 = Ingredient {
            name: "dupe".into(),
            quality: Quality::High,
            ..Default::default()
        };
        let novel = Ingredient {
            name: "novel".into(),
            quality: Quality::Any,
            ..Default::default()
        };
        ...
        let dupe_selector = IngredientSelector {
            name: Some("dupe".into()),
            quality: None,
            tags: None,
            in_stock: None,
        ...
        let novel_selector = IngredientSelector {
        ...
        let none_selector = IngredientSelector {
            name: None,
            quality: None,
            tags: None,
            in_stock: None,
        ...
        let bad_selector = IngredientSelector {
            name: Some("fake".into()),
            quality: None,
            tags: None,
            in_stock: None,
